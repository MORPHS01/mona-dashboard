          ...
          <table className="w-full">
            ...
            <tbody>
              {paginatedTransactions.map((transaction, i) => (
                <tr
                  key={i}
                  className="border-t border-divider hover:bg-background whitespace-nowrap cursor-pointer text-gray-300 text-sm font-normal font-generalSans"
                >
                  ...
                  <td className="p-[16px]">
                    <div className="p-[8px] rounded-md text-[10px] leading-[16px] font-medium border border-divider flex items-center gap-[4px] max-w-fit">
                      <Icon
                        name={
